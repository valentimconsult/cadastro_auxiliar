...
# Script simplificado para iniciar a aplicacao no Raspberry Pi
# Versao sem dependencias de healthcheck para maior compatibilidade

echo "=== Iniciando Cadastro Auxiliar no Raspberry Pi (Versao Simplificada) ==="
